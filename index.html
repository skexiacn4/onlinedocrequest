...
<html lang="en">
    ...
    <body>
       ...
       <section id="login.php">home</section>
       <section id="contact.php">home</section>
       <section id="about.php">home</section>
      ...
      <div class="wrapper">
        ...
        <form method="post">
          <div class="row">
            ...
            <input id="text1" type="text" placeholder="" name="user_name" required>
          </div>
          <div class="row">
            <i class="fas fa-lock"></i>
            <input id="text2" type="password" placeholder="" name ="password" required>
          </div>
